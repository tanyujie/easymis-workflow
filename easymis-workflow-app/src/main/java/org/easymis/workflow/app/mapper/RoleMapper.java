...
public interface RoleMapper {
    ...
    Role findById(@Param("dbsId") String dbsId);
	...
	@Results({
		@Result(property = "permissions", column = "role_id", many = @Many(select = "org.easymis.workflow.app.mapper.PermissionMapper.findByRoleId")) })
