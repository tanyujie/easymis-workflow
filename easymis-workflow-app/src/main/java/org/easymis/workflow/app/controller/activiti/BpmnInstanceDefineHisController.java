...
@RestController
@Api(value = "结束实例controller", tags = { "结束实例操作接口" })
@RequestMapping("/bpmn/instance/bpmDefineHis")
public class BpmnInstanceDefineHisController {
    @Autowired
	...
	public ModelAndView index1(HttpSession httpSession) {
		...
		ModelAndView mv = new ModelAndView("bpmn/instance/bpmDefineHis/index");
		return mv;
	}
