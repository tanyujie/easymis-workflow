...
public interface OrganizeResourceMapper {
    ...
    int insertByBean(OrganizeResource bean);
    ...
    List<OrganizePosition> findAll();
    @Select("SELECT * FROM ew_bpmn_category")
    List<OrganizeResourceVO> findByBean(OrganizeResourceVO vo);
}
