...
public interface OrganizeEmployeeMapper {
    @Select("SELECT * FROM dam_login_log WHERE login_log_id = #{loginLogId}")
    OrganizeEmployee findById(@Param("loginLogId") String loginLogId);
    ...
    int insertByBean(OrganizeEmployee bean);
